...
export default function NavBar() {
  return (
    <div className={style.globalContainer} style={navStyle}>
    ...
    <Link to="/payment">
      {/* <button className='mx-2 text-zinc-100 hover:text-4-color transition ease-in duration-200 text-xl p-1 font-semibold'> Carrito </button> */}
      <CarritoIcon/>
    </Link>
    <Link to="/login">
      ...
      <Link to="/admin">
      <button className='mx-2 text-zinc-100 bg-4-color w-24 h-12 rounded-lg hover:bg-zinc-100 hover:text-4-color transition ease-in duration-200 text-xl p-1'> Admin </button>
      </Link>  
