        ...
        <div className={s.containerFooterInfo}>
          ...
          <ul className="flex flex-row my-4">
            <Link to={"/legales"} className="no-underline">
              <li className=" text-zinc-300 hover:text-5-color transition ease-in duration-200 cursor-pointer text-xl font-semibold">
                Legales
              </li>
            </Link>
          </ul>
        ...
        <div className={s.containerFooterInfo}>
          ...
          <ul className="flex flex-row my-4">
            <Link to={"/aboutus"} className="no-underline ">
              <li className="text-zinc-300 hover:text-4-color transition ease-in duration-200 cursor-pointer text-xl font-semibold">
                About Us
              </li>
            </Link>
          </ul>
